									   ...
									   <div class="error_page">
													...
													<h2 class="inner-tittle page">Augment</h2>
														...
														<h3 class="inner-tittle t-inner">Login</h3>
                                                                ...
                                                                <input type="text" placeholder="name" name="name">
																		...
																		<div class="submit"><input type="submit" name="send" value="Login" ></div>
																		<div class="clearfix"></div>
																		
																		<div class="new">
                                                                      
																			<p class="sign up">Do you have an account yet ? <a href="sign.php"> Sign up here.</a></p>
										  ...
										  // if($_SERVER['REQUEST_METHOD']=='POST'){
											...
											if(isset($_POST['send'])){
											   ...
											   $query="SELECT*FROM users WHERE( name='$name' AND email='$email' AND password='$pass')";
